#include "TestCasterFlashLight.h"
#include "Renderer.h"
...
namespace test
{
	TestCasterFlashLight::TestCasterFlashLight()
...

	{
		...
		m_Shader = std::make_unique<Shader>("res/Shaders/LearningOpenglShader/Light/MapVertexShader.vert", "res/Shaders/LearningOpenglShader/Light/LightCasterFlashlightFragShader.frag");
	...
	void TestCasterFlashLight::OnUpdate(float deltaTime)
	{

	}

	void TestCasterFlashLight::OnRender()
	{
...

		{
			...
			m_Shader->SetUniformVec3f("u_Light.position", m_camera->Position);
			m_Shader->SetUniformVec3f("u_Light.direction", m_camera->Front);
	...
	void TestCasterFlashLight::processInput(GLFWwindow* window, float deltaTime)
	{
	...
	void TestCasterFlashLight::setCamera(Camera* camera)
	{
		m_camera = camera;
	...
	void TestCasterFlashLight::OnImGuiRender()
	{
