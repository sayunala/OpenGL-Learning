...
namespace test
{
	TestCaterPointLight::TestCaterPointLight()
...

	{
		...
		m_Shader = std::make_unique<Shader>("res/Shaders/LearningOpenglShader/Light/MapVertexShader.vert", "res/Shaders/LearningOpenglShader/Light/LightCasterFragShader.frag");
	...
	void TestCaterPointLight::OnUpdate(float deltaTime)
	{

	}

	void TestCaterPointLight::OnRender()
	{
	...
	void TestCaterPointLight::processInput(GLFWwindow* window, float deltaTime)
	{
	...
	void TestCaterPointLight::setCamera(Camera* camera)
	{
		m_camera = camera;
	...
	void TestCaterPointLight::OnImGuiRender()
	{
