...
namespace test
{
...

	{
		...
		m_Shader = std::make_unique<Shader>("res/Shaders/LearningOpenglShader/Light/MapVertexShader.vert", "res/Shaders/LearningOpenglShader/Light/MapFragShader.frag");
	...
	void TestMap::OnUpdate(float deltaTime)
	{

	}

	void TestMap::OnRender()
	{
	...
	void TestMap::processInput(GLFWwindow* window, float deltaTime)
	{
	...
	void TestMap::setCamera(Camera* camera)
	{
		m_camera = camera;
